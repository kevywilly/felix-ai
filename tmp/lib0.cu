...
void fused_rms_norm1_cutlass_(DLTensor* lv1613, DLTensor* model_layers_0_input_layernorm_weight, DLTensor* out0){
...
void fused_relax_nn_attention_cutlass1_(DLTensor* lv1625, DLTensor* lv1635, DLTensor* lv1636, DLTensor* workspace_2, DLTensor* out0){
  ...
  uint64_t accumulator_buf_size = 1 * 1 * 20 * 128 * sizeof(Attention::output_accum_t);
...
void fused_decode9_relax_matmul_relax_add1_cutlass_(DLTensor* model_layers_0_mlp_down_proj_weight_int8_01, DLTensor* model_layers_0_mlp_down_proj_weight_float16_11, DLTensor* lv52, DLTensor* lv44, DLTensor* out0){
...
void fused_decode9_relax_matmul_relax_add_cutlass_(DLTensor* model_layers_0_mlp_down_proj_weight_int8_0, DLTensor* model_layers_0_mlp_down_proj_weight_float16_1, DLTensor* lv1661, DLTensor* lv1653, DLTensor* out0){
...
void fused_relax_nn_attention1_cutlass1_(DLTensor* lv16, DLTensor* lv26, DLTensor* lv27, DLTensor* workspace, DLTensor* out0){
  ...
  p.output_accum_ptr = nullptr;
  uint64_t accumulator_buf_size = 1 * lv16->shape[1] * 20 * 128 * sizeof(Attention::output_accum_t);
  bool accumulator_buf_allocated = false;
  if (Attention::kNeedsOutputAccumulatorBuffer) {
...
void fused_decode7_relax_matmul_relax_add1_cutlass_(DLTensor* model_layers_0_self_attn_o_proj_weight_int8_01, DLTensor* model_layers_0_self_attn_o_proj_weight_float16_11, DLTensor* lv41, DLTensor* inputs_embeds, DLTensor* out0){
...
void fused_decode7_relax_matmul_relax_add_cutlass_(DLTensor* model_layers_0_self_attn_o_proj_weight_int8_0, DLTensor* model_layers_0_self_attn_o_proj_weight_float16_1, DLTensor* lv1650, DLTensor* lv1613, DLTensor* out0){
